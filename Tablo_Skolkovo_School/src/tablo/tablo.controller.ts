...
export class TabloController extends BaseController {
    ...
    checkTablo1(req: Request, res: Response, next: NextFunction) {
        this.ok(res, 'Tablo 1 ok');
    }

    checkTablo2(req: Request, res: Response, next: NextFunction) {
        this.ok(res, 'Tablo 2 ok');
    }

    sendTablo1(req: Request, res: Response, next: NextFunction) {
        this.ok(res, 'Tablo 1 message sent');
    }

    sendTablo2(req: Request, res: Response, next: NextFunction) {
